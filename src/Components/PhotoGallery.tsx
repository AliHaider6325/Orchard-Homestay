...
const GALLERY_DATA: Album[] = [
  ...
  },
  {
    ...
    images: [
      ...
      "/assets/gallery/interiors/2.png",
      "/assets/gallery/interiors/3.jpg",
    ],
  },
  {
    title: "Surroundings",
    cover: "/assets/surrondings.png",
    description:
      "The apple orchard, nearby landscapes, and stunning Kashmir views.",
    images: [
      "/assets/gallery/surrondings/1.jpg",
      "/assets/gallery/surrondings/2.jpg",
      "/assets/gallery/surrondings/3.jpg",
      "/assets/gallery/surrondings/4.jpg",
      "/assets/gallery/surrondings/5.jpg",
      "/assets/gallery/surrondings/6.jpg",
      "/assets/gallery/surrondings/7.jpg",
      "/assets/gallery/surrondings/8.jpg",
      "/assets/gallery/surrondings/9.jpg",
      "/assets/gallery/surrondings/10.jpg",
      "/assets/gallery/surrondings/11.jpg",
    ],
  },
  {
    title: "Food & Dining",
    ...
    images: [
      "/assets/gallery/food/f2.jpg",
      "/assets/gallery/food/f3.jpg",
      "/assets/gallery/food/f4.jpg",
      "/assets/gallery/food/f5.jpg",
      "/assets/gallery/food/f6.jpg",
    ],
  },
];
